                                ...
                                {profileData.provider === 'google' && !profileData.usernameChanged && (
                                    <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-2xl p-6 mb-2">
                                        ...
                                        <div className="relative">
                                            <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 font-mono text-xs leading-none flex items-center">
                                                malinks.web.id/
                                            </div>
                                            <input
                                                type="text"
                                                ...
                                                className={`w-full bg-slate-900 border ${usernameError ? 'border-red-500' : 'border-slate-700'} rounded-xl py-3 pl-[100px] pr-4 text-white focus:outline-none focus:border-indigo-500 font-mono text-sm transition-all`}
                                            />
